(function () {
	...
	/**
	 * Introduce the clickbattleApp.user module
	 * and configure it.
	 *
	 * @requires ngResource
	 * @requires ui.router
	 * @requires {clickbattleApp.admin.user.list}
	 * @requires {clickbattleApp.admin.user.create}
	 */
	angular
		.module('clickbattleApp.admin.user', [
			'ngResource',
			'ui.router',
			'clickbattleApp.admin.user.list',
			'clickbattleApp.admin.user.create'
		])
