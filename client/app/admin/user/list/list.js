(function () {
	...
	/**
	 * Introduce the clickbattleApp.admin.user.list module
	 * and configure it.
	 *
	 * @requires ui.router
	 * @requires ngMaterial
	 ...
	 * @requires clickbattleApp.admin.user.list.detail
	 * @requires clickbattleApp.admin.user.list.edit
	 * @requires clickbattleApp.admin.user.list.items
	 */

	angular
		.module('clickbattleApp.admin.user.list', [
			'ngMaterial',
			'ui.router',
			'clickbattleApp.socket',
			'clickbattleApp.mainMenu',
			'clickbattleApp.toggleComponent',
			'clickbattleApp.admin.user.list.detail',
			'clickbattleApp.admin.user.list.edit',
			'clickbattleApp.admin.user.list.items'
		])
