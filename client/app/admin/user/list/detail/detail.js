/**
 * @ngdoc overview
 * @name clickbattleApp.admin.user.list.detail
 * @description
 * The `clickbattleApp.admin.user.list.detail` module which provides:
 *
 * - {@link clickbattleApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires clickbattleApp.auth.user
 */
(function () {
	'use strict';
