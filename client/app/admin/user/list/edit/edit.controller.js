/**
 * @ngdoc controller
 * @name clickbattleApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name clickbattleApp.admin.user.list.edit.provider:UserEditController
	 * @description
	 * Provider of the {@link clickbattleApp.admin.user.list.edit.controller:UserEditController UserEditController}
