/**
 * @ngdoc overview
 * @name clickbattleApp.admin.user.create
 * @description
 * The `clickbattleApp.admin.user.create` module which provides
 *
 * - {@link clickbattleApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
